        ...
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between">
                ...
                <nav class="flex gap-2 items-center">
                    ...
                    @auth
                    <a class="flex items-center gap-2 bg-white border" href="{{route('post.create')}}">
                    ...
                    <form action="{{route('logout')}}" method="POST">
                        @csrf
                        <button class="font-bold uppercase text-gray-600" href="#">
                            Cerrar Sesion
                        </button>
                    </form>
...
<footer class="text-ceneter p-5 text-gray-500 font-bold">
    DevStagram
    {{now()->year}}
</footer>
    </body>
